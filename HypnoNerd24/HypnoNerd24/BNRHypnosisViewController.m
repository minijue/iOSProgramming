...
- (void)loadView
{
    ...
    backgroundView.restorationIdentifier = @"BNRHypnosisView";
    
    CGRect textFieldRect = CGRectMake(40, 70, 240, 30);
    _textField = [[UITextField alloc] initWithFrame:textFieldRect];
    _textField.restorationIdentifier = @"UITextField";
...
- (void)encodeRestorableStateWithCoder:(NSCoder *)coder {
    ...
    [coder encodeObject:txt forKey:@"text"];
    
    [super encodeRestorableStateWithCoder:coder];
}

- (void)decodeRestorableStateWithCoder:(NSCoder *)coder {
    NSString *txt = [coder decodeObjectForKey:@"text"];

...
//    [self.tableView registerClass:[BNRTableViewCell class] forCellReuseIdentifier:@"UITableViewCell"];
    UINib *nib = [UINib nibWithNibName:@"BNRTableViewCell" bundle:nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    BNRTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"UITableViewCell" forIndexPath:indexPath];
    ...
    NSString *lastDate = @"";
    for (NSDictionary *item in upcoming) {
        if (item[@"start_date"] > lastDate) {
            lastDate = item[@"start_date"];
        }
    }
    cell.dateLabel.text = lastDate;
